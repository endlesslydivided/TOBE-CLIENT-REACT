...
import { DialogListItem, FriendsListItem, RequestListItem, UsersListItem } from '../../components/avatarList/AvatarList';
...
const DialogList:FC<IDialogListProps>= ({filters,setFilters,...other}) => 
{
